...
export const PaginaInicio = ({ funcion }) => {
    ...
    <div className="container-fluid">
      ...
      <nav className="navbar navbar-expand-xl barraNavegacion">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0 formatoMenu">
              <li className="nav-item dropdown">
                <Link to="/Login" className="nav-link active formatoMenu" aria-current="page">Ingresar</Link>
              </li>
            </ul>
      ...
      <section className = "container-fluid carrusel">
        <div className="row formatoProductos">
          <div className="col-sm-3 col-md-6 col-lg-6 col-xl-3 mb-3 mb-sm-0">
            <div className="card">

...
export const ActualizarNumTelefonico = () => {
  ...
  const modificar = async (e) => {
    ...
    await fetch(`http://localhost:3001/actualizarClientes/actualizarNumTelefonico/${nit}`, {
      method : 'PUT',
      headers : { 
    ...
    <article className='col-4 col-md-4'>
      <form className="col-9 col-md-9 formatoActualizarCliente">
        ...
        <div className ="col-12 col-md-12">
          ...
          <input type="text" className="form-control formatoInput" id="numeroTelefonico" onChange = {(e) => setNumeroTelefonico(e.target.value)} required></input>
        </div>

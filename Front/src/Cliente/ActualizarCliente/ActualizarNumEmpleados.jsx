...
export const ActualizarNumEmpleados = () => {
  ...
  const modificar = async (e) => {
    ...
    await fetch(`http://localhost:3001/actualizarClientes/actualizarNumEmpleados/${nit}`, {
      method : 'PUT',
      headers : { 
    ...
    <article className='col-12 col-md-4'>
      <form className="col-9 col-md-9 formatoActualizarCliente">
        ...
        <div className ="col-12 col-md-12">
          ...
          <input type="number" className="form-control formatoInput" id="numEmpleados" onChange = {(e) => setNumEmpleados(e.target.value)} required></input>
        </div>

...
export const ActualizarCantidadPedido = () => {
  ...
  const modificar = async (e) => {
    ...
    if(!idProducto || !idPedido || !cantidad) {
    ...
    await fetch(`http://localhost:3001/actualizarProductoPedido/actualizarCantidad/${idPedido}`, {
      method : 'PUT',
      headers : { 

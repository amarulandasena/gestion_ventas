...
export const ActualizarFechaDeIngreso = () => {
  ...
  const modificar = async (e) => { 
    ...
    if(!numIdentificacion || !fechaIngreso) {
    ...
    await fetch(`http://localhost:3001/actualizarEmpleados/actualizarFechaIngreso/${numIdentificacion}`, {
      method : 'PUT',
      headers : { 
    ...
    <article className='col-4 col-md-4'>
      <form className="col-9 col-md-9 formatoActualizarCliente">
        ...
        <div className ="col-12 col-md-12">
          ...
          <input type="date" className="form-control formatoInput" id="fechaIngreso" onChange = {(e) => setFechaIngreso(e.target.value)} required />
        </div>

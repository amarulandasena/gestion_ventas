...
export const ActualizarApellidos = () => {
  ...
  const modificar = async (e) => { 
    ...
    if(!numIdentificacion || !apellidos) {
    ...
    await fetch(`http://localhost:3001/actualizarEmpleados/actualizarApellidos/${numIdentificacion}`, {
      method : 'PUT',
      headers : { 
    ...
    <article className='col-4 col-md-4'>
      <form className="col-9 col-md-9 formatoActualizarCliente">
        ...
        <div className ="col-12 col-md-12">
          ...
          <input type="text" className="form-control formatoInput" id="apellidos" onChange = {(e) => setApellidos(e.target.value)} required />
        </div>

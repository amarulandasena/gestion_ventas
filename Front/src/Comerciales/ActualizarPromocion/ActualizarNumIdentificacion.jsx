...
export const ActualizarNumIdentificacion = () => {
  ...
  const modificar = async (e) => {
    ...
    await fetch(`http://localhost:3001/actualizarPromociones/actualizarNumIdentificacion/${codigo}`, {
      method : 'PUT',
      headers : { 
  ...
  return (
    <article className='col-12 col-md-4'>
      <form className="col-9 col-md-9 formatoActualizarCliente" ref={limpiarFormulario}>
        ...
        <div className ="col-12 col-md-12">
          <label htmlFor="numIdentificacion1" className="form-label">Código:</label>
          <input type="text" className="form-control formatoInput" id="numIdentificacion1" onChange = {(e) => setNumIdentificacion1(e.target.value)} required />
        </div>
